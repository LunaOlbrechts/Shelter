    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        private void AddData()
        {
            ...
            var Shelter2 = new Shelters()
            {
                ...
                Animals = new List<Animal> {
                    new Dog() { Name = "Bahia", DateOfBirth = "14-09-2015", IsChecked = true, KidFriendly = true, Since = "07-03-2019", Race = "Dalmatian", Barker = false, Id=3,SheltersId=2},
                    new Cat() {Name = "Max", DateOfBirth = "29-06-2018", IsChecked = false, KidFriendly = false, Since = "16-10-2019", Race = "Seamese", Declawed = true, Id = 4, SheltersId=2},
                    new OtherAnimal() {Name = "Flappie", DateOfBirth = "03-04-2019", IsChecked = true, KidFriendly = true, Since = "28-07-2019", Race = "Vlaamse Reus", Description = "blablabla", Kind = "Rabbit", Id = 5, SheltersId=2}
                }
            };
